package org.hy.common.modbus.junit.cflow025;
...
import org.hy.common.modbus.junit.cflow025.program.Program;
...
public class JU_CFlow025 extends JUBase
{
    ...
    {
        List<MDataItem> v_MItems = new ArrayList<MDataItem>();
        ...
        XJava.putObject("LEDData_01" ,v_MItems);
    }
    
    
    
    @Test
    public void test_CFlow025() throws InterruptedException
    {
        test_CFlow025_Inner();
    ...
    private void test_CFlow025_Inner() throws InterruptedException
    {
        // 初始化被编排的执行对象方法
        XJava.putObject("XProgram" ,new Program());
        
        // 获取编排中的首个元素
        ForConfig           v_ForConfig = (ForConfig) XJava.getObject("XFor_CF025_1");
